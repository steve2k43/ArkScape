...
import net.nocturne.game.npc.corp.CorporealBeast;
import net.nocturne.game.npc.dagannoth.DagannothFledgeling;
import net.nocturne.game.npc.dagannoth.DagannothKing;
import net.nocturne.game.npc.dragons.FrostDragon;
import net.nocturne.game.npc.dragons.KingBlackDragon;
import net.nocturne.game.npc.evilchicken.EvilChicken;
import net.nocturne.game.npc.glacior.Glacor;
import net.nocturne.game.npc.godwars.GodWarMinion;
import net.nocturne.game.npc.godwars.armadyl.GodwarsArmadylFaction;
import net.nocturne.game.npc.godwars.armadyl.KreeArra;
import net.nocturne.game.npc.godwars.bandos.GeneralGraardor;
import net.nocturne.game.npc.godwars.bandos.GodwarsBandosFaction;
import net.nocturne.game.npc.godwars.saradomin.CommanderZilyana;
...
import net.nocturne.game.npc.godwars.zammorak.KrilTstsaroth;
import net.nocturne.game.npc.godwars.zaros.Nex;
import net.nocturne.game.npc.godwars.zaros.NexMinion;
import net.nocturne.game.npc.godwars.zaros.ZarosMinion;
import net.nocturne.game.npc.godwars2.SerenFaction;
import net.nocturne.game.npc.godwars2.SliskeFaction;
import net.nocturne.game.npc.godwars2.ZamorakFaction;
import net.nocturne.game.npc.godwars2.ZarosFaction;
...
import net.nocturne.game.npc.kalphite.KalphiteQueen;
import net.nocturne.game.npc.lucien.Lucien;
import net.nocturne.game.npc.nomad.FlameVortex;
import net.nocturne.game.npc.nomad.Nomad;
import net.nocturne.game.npc.others.AbyssalDemon;
import net.nocturne.game.npc.others.BanditCampBandits;
import net.nocturne.game.npc.others.BlackDemon;
import net.nocturne.game.npc.others.ChaosElemental;
import net.nocturne.game.npc.others.ConditionalDeath;
import net.nocturne.game.npc.others.Cyclopse;
import net.nocturne.game.npc.others.DoorSupport;
import net.nocturne.game.npc.others.Ducks;
import net.nocturne.game.npc.others.Elemental;
import net.nocturne.game.npc.others.HarpieBug;
import net.nocturne.game.npc.others.HoleInTheWall;
import net.nocturne.game.npc.others.HunterTrapNPC;
import net.nocturne.game.npc.others.Jadinko;
import net.nocturne.game.npc.others.Kurask;
import net.nocturne.game.npc.others.Legio;
import net.nocturne.game.npc.others.LivingRock;
import net.nocturne.game.npc.others.MasterOfFear;
import net.nocturne.game.npc.others.MaxTheMaxed;
import net.nocturne.game.npc.others.MercenaryMage;
import net.nocturne.game.npc.others.MutatedZygomites;
import net.nocturne.game.npc.others.Nechryael;
import net.nocturne.game.npc.others.PolyporeCreature;
import net.nocturne.game.npc.others.Revenant;
import net.nocturne.game.npc.others.RockCrabs;
import net.nocturne.game.npc.others.SaltyCrabletine;
import net.nocturne.game.npc.others.Sheep;
import net.nocturne.game.npc.others.SkillAlchemistNPC;
import net.nocturne.game.npc.others.Strykewyrm;
import net.nocturne.game.npc.others.TheDarkOracle;
import net.nocturne.game.npc.others.TormentedDemon;
import net.nocturne.game.npc.others.Werewolf;
...
import net.nocturne.game.player.actions.skills.runecrafting.SiphonActionNodes;
import net.nocturne.game.player.content.LivingRockCavern;
...
import net.nocturne.game.player.controllers.JadinkoLair;
...
import net.nocturne.utils.sql.Exchange;
...
public final class World {
	...
	private static void addBondsTask() {
		GameExecutorManager.slowExecutor.scheduleWithFixedDelay(new Runnable() {
			@Override
			public void run() {
				try {
	...
	public static void sendProjectile(WorldObject object,
