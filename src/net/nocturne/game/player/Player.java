...
public class Player extends Entity {
	...
	public void start() {
		...
		started = true;
		setOnline(true);
		if (Settings.DOUBLE_XP == true)
			getPackets().sendConfigByFile(223, 1);
		run();
	}
	...
	private void appendStarter() {
		...
		getPackets().sendGameMessage("You have 3 Treasure Hunter keys.");
		getPackets().sendForceGameMessage(
				Color.PURPLE,
	...
	public double getDropChance() {
		int z = getDifficulty();
		if(z==1)
			dropChance=Settings.DROP_CHANCE_EASY;
		if(z==2)
