...
public class InterfaceManager {
	...
	private void customTab() {
		...
		player.getPackets().sendIComponentText(506, 10, "Donate");
		player.getPackets().sendIComponentText(506, 12, "Req Support");
		player.getPackets().sendIComponentText(506, 14, "Submit Bug");
		String a="Player";
	...
	public void unlockSubscribe() {
		...
		player.getPackets().sendIComponentText(1484, 12, "Donate ("+player.getDonationManager().getDonatorTitle()+")");
	}
