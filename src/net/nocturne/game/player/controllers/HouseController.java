...
import net.nocturne.game.npc.construction.ServantNPC;
import net.nocturne.game.player.Equipment;
import net.nocturne.game.player.MusicsManager;
import net.nocturne.game.player.Skills;
import net.nocturne.game.player.actions.skills.construction.*;
import net.nocturne.game.player.actions.skills.construction.House.RoomReference;
import net.nocturne.game.player.actions.skills.construction.HouseConstants.Builds;
...
public class HouseController extends Controller {
	...
	public boolean processButtonClick(int interfaceId, int componentId,
		...
		System.out.println("TRYING TO BUILD clicky");
		if (interfaceId == 400) {
